...
const handleAboutUsClick = () => {
    ...
    setShowApp2(true);// Hide the cart when navigating to About Us
 };
        ...
        <div>
            ...
            <div className="tag">
               ...
               <a   style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>Nature Love Plants</h3>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e)=>handleAboutUsClick()} style={styleA}>About Us</a></div>
